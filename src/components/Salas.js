                    ...
                    <table class="text-left w-full border-collapse">
                        ...
                        <tbody>
                            <tr class="hover:bg-grey-lighter">
                                ...
                                <td class="py-4 px-7 border-b border-grey-light">
                                    <button href="#" class="bg-blue hover:bg-blue-dark text-dark font-bold py-2 px-4 rounded">Edit</button>
                                    <button href="#" class="bg-green hover:bg-green-dark text-dark font-bold py-2 px-4 rounded">View</button>
                                </td>
                            </tr>
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-7 border-b border-grey-light">
